...
func main() {
	...
	cfg, err := config.ParseAddress("127.0.0.1:8715?topic=test_topic&group=test_group")
	...
	for {
		...
		cr, err := c.GetMessage()
		//log.Debug(cr.TopicName)
		//log.Debug(cr.Messages)
		fmt.Println(cr.TopicName)
